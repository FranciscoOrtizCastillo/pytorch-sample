...
print("Step 1: Create a dataloader for Pytorch")
...
grid_imgs = torchvision.utils.make_grid(samples[:32],normalize=True)
...
print("Step 3: Define Deep Learning model")
...
print("Step 4: Define train_step and predict functions")
def train_step(train_loader, model, optimizer, criterion, device):
    ...
    for i, (inputs, targets) in enumerate(train_loader):
        print(f'enumerate mini batches : {i} / train dataloader size: {len(train_loader)}')
...
print("Step 5: Define main train function")
...
print("Step 6: Training parameters, model declaration and training/validation process")
...
lr = 0.001
weight_dec = 0.001
model_file_name = "models/dogs_cats_model"+version+".pth"
...
plt.savefig('models/loss'+version+'.png')
...
plt.ylabel("Acuracy (%)")
plt.legend(["Train", "Validation"])
plt.savefig('models/acc'+version+'.png')
